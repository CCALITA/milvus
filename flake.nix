    ...
    let
      ...
      shell = pkgs.mkShell {
        ...
        shellHook = ''
          ...
          export MILVUS_BOOST_B2_LINKFLAGS="-L$MILVUS_LIBCXX_LIBDIR -L$MILVUS_LIBUNWIND_LIBDIR -Wl,-rpath,$MILVUS_LIBCXX_LIBDIR -Wl,-rpath,$MILVUS_LIBUNWIND_LIBDIR -stdlib=libc++ -fuse-ld=lld"
          ...
          export LIBRARY_PATH="$MILVUS_LIBCXX_LIBDIR:$MILVUS_LIBUNWIND_LIBDIR''${LIBRARY_PATH:+:$LIBRARY_PATH}"
