...
class LibibertyConan(ConanFile):
    ...
    def build(self):
        # On the Linux Nix clang+libc++ proof host, Conan 1 sometimes unpacks
        # libiberty's generated configure script without the executable bit.
        # Restore the mode locally while keeping the same public GNU tarball.
        configure = os.path.join(self._libiberty_folder, "configure")
