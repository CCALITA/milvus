...
class LiunwindConan(ConanFile):
    ...
    def build(self):
        ...
        # On the Linux Nix clang+libc++ proof host, Conan 1 can unpack libunwind's
        # generated configure script without its executable bit. Keep using the same
        # public release tarball, but restore the mode before autotools.configure().
